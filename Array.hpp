...
void arrayDemo()
{
    ...
    std::cout << "target: ";
    printAll<int *>(target.begin(), target.end());
    std::cout << "source: ";
    printAll<int *>(containerArray.begin(), containerArray.end());
    std::array<std::string, 3> stringArray = {"abcd", "1234", "+-*/"};
    auto targetStringArray = std::move(stringArray);
    std::cout << "target: ";
    printAll<std::string *>(targetStringArray.begin(), targetStringArray.end());
    std::cout << "source: ";
    printAll<std::string *>(stringArray.begin(), stringArray.end());
    printDivider();
